        ...
        <section className=' py-8'>
            <div className='container mx-auto  flex  justify-between'>
                ...
                <div className='flex flex-nowrap gap-4 pt-1'>
                    <Link className=' text-sm font-semibold  px-5 py-2 ' href="/">Home</Link>
                    <Link className=' text-sm font-semibold  px-5 py-2 ' href="/team">Team</Link>
                    <Link className=' text-sm font-semibold  px-5 py-2 ' href="/service">Service</Link>
                    <Link className=' text-sm font-semibold  px-5 py-2 ' href="/projects">Projects</Link>
                    <Link className=' text-sm font-semibold  px-5 py-2 ' href="/testimonials">Testimonials</Link>
